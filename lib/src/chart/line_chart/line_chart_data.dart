...
import 'package:disys_charts/disys_charts.dart';
import 'package:disys_charts/src/chart/line_chart/line_chart_helper.dart';
import 'package:disys_charts/src/extensions/color_extension.dart';
import 'package:disys_charts/src/extensions/gradient_extension.dart';
import 'package:disys_charts/src/utils/lerp.dart';
...
class LineChartBarData with EquatableMixin {
  ...
  /// check this [issue](https://github.com/imaNNeoFighT/disys_charts/issues/25)
...
///
/// There is a touch flow, explained [here](https://github.com/imaNNeoFighT/disys_charts/blob/master/repo_files/documentations/handle_touches.md)
